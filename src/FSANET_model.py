...
from src.capsulelayers import CapsuleLayer
...
class FSA_net_Capsule:
    ...
    def __call__(self):
        ...
        pred_pose = Lambda(SSR_module, arguments={'s1': self.stage_num[0], 's2': self.stage_num[1],
                                                  's3': self.stage_num[2], 'lambda_d': self.lambda_d},
                           name='pred_pose')(ssr_F_Cap_list)
